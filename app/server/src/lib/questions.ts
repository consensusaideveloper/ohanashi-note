...
export const QUESTIONS: Question[] = [
  ...
  { id: "house-04", category: "house", title: "内密に処分してほしいもの" },
  ...
  { id: "medical-13", category: "medical", title: "もしもの備え・財産の管理" },
  {
    id: "medical-05",
    category: "medical",
    title: "延命治療の希望",
  ...
  { id: "funeral-06", category: "funeral", title: "葬儀に呼ぶ人・呼ばない人" },
  ...
  { id: "money-16", category: "money", title: "株や投資のこと（有価証券）" },
  ...
  { id: "work-06", category: "work", title: "仕事の免許や契約書（許認可）" },
  { id: "work-07", category: "work", title: "事業用の借入・保証" },
  { id: "work-08", category: "work", title: "顧問の専門家" },
  { id: "work-09", category: "work", title: "自分の作品や特許（知的財産）" },
  ...
  { id: "digital-02", category: "digital", title: "ネット証券・つみたてNISA" },
  ...
  { id: "digital-08", category: "digital", title: "声や姿を残すこと" },

  // legal
  { id: "legal-01", category: "legal", title: "ご家族の構成（法定相続人）" },
  { id: "legal-02", category: "legal", title: "財産の整理（相続財産）" },
  { id: "legal-03", category: "legal", title: "遺言書の種類と保管" },
  { id: "legal-04", category: "legal", title: "遺言を届ける人" },
  {
    id: "legal-05",
    category: "legal",
  ...
  { id: "legal-07", category: "legal", title: "税金がかからない仕組みの活用" },
  {
    id: "legal-08",
    category: "legal",
  ...
  { id: "legal-10", category: "legal", title: "寄付のご希望" },
  { id: "legal-11", category: "legal", title: "借金の引き継ぎについて" },
