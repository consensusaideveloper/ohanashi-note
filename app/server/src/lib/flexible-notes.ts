// Server-side port of client/src/lib/flexible-notes.ts
// Pure logic — no React/browser dependencies.

import { normalizeInsightStatement } from "../types/conversation.js";
...
function overlapsStructuredNote(
  statement: string,
  noteEntries: readonly NoteEntryMinimal[],
): boolean {
