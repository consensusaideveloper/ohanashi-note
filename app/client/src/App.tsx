...
function AppContent(): ReactNode {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-bg-primary">
      ...
      {/* Main content area */}
      <div className="flex-1 flex flex-col pb-[72px] md:pb-[80px]">
        {renderScreen()}
      </div>
      ...
      {!isTabHidden && (
        <nav className="fixed bottom-0 left-0 right-0 bg-bg-surface border-t border-border">
          <div className="flex max-w-2xl mx-auto">
            <button
              type="button"
              className={`flex-1 min-h-[64px] md:min-h-[72px] flex flex-col items-center justify-center gap-1 transition-colors ${
                screen === "conversation"
                  ? "text-accent-primary"
