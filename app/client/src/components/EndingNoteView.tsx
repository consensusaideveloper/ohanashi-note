  ...
  return (
    <div className="flex-1 flex flex-col w-full overflow-hidden">
      ...
      <div className="flex-none px-4 pt-8 pb-4">
        ...
        {onNavigateProgress !== undefined && (
          <button
            type="button"
            className="mt-2 w-full min-h-11 rounded-full border border-accent-primary text-accent-primary text-lg font-medium px-4 py-2 hover:bg-accent-primary-light/30 active:bg-accent-primary-light/50 transition-colors flex items-center justify-center gap-2"
